    ...
    <section class="py-12 bg-white sm:py-16 lg:py-20">
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="text-center">
          <h2 class="text-2xl font-bold text-gray-900 sm:text-3xl">Select from a popular category</h2>
        </div>
            ...
            <div class="p-6 lg:px-10 lg:py-8">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12">
                ...
                <div>
                  ...
                  <p class="mt-2 text-sm font-medium text-gray-500">983 Businesses</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="p-6 lg:px-10 lg:py-8">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12">
                ...
                <div>
                  ...
                  <p class="mt-2 text-sm font-medium text-gray-500">142 Businesses</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="p-6 lg:px-10 lg:py-8">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-12 h-12">
                ...
                <div>
                  ...
                  <p class="mt-2 text-sm font-medium text-gray-500">476 Businesses</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="p-6 lg:px-10 lg:py-8">
              <div class="flex items-center justify-start space-x-8">
                ...
                <div>
                  ...
                  <p class="mt-2 text-sm font-medium text-gray-500">849 Businesses</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="p-6 lg:px-10 lg:py-8">
              <div class="flex items-center justify-start space-x-8">
                ...
                <div>
                  ...
                  <p class="mt-2 text-sm font-medium text-gray-500">253 Businesses</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="p-6 lg:px-10 lg:py-8">
              <div class="flex items-center justify-start space-x-8">
                ...
                <div>
                  ...
                  <p class="mt-2 text-sm font-medium text-gray-500">94 Businesses</p>
                </div>
              </div>
            </div>
          </div>
