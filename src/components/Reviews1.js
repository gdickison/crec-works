            ...
            <div className="grid grid-cols-1 gap-y-8 sm:grid-cols-2 gap-x-16">
                <div>
                    ...
                    <div className="flex items-center mt-6">
                        ...
                        <span className="ml-3 text-sm font-medium text-gray-600"> (4.7 out of 5) </span>
                    </div>
                    <p className="text-sm font-medium text-gray-600 mt-2.5">Based on 3,498 reviews</p>
                </div>

                <div>
                    <ul className="space-y-2.5">
                        <li className="grid items-center grid-cols-5 gap-x-4">
                            <span className="text-sm font-medium text-gray-600 whitespace-nowrap"> 5 stars </span>
                            ...
                            <span className="text-sm font-medium text-gray-600 whitespace-nowrap"> 2,388 </span>
                        </li>

                        <li className="grid items-center grid-cols-5 gap-x-4">
                            <span className="text-sm font-medium text-gray-600 whitespace-nowrap"> 4 stars </span>
                            <div className="col-span-3 relative w-full bg-gray-200 rounded-full h-1.5">
                                <div className="absolute inset-y-0 left-0 w-[30%] bg-gray-900 rounded-full"></div>
                            </div>
                            <span className="text-sm font-medium text-gray-600 whitespace-nowrap"> 785 </span>
                        </li>

                        <li className="grid items-center grid-cols-5 gap-x-4">
                            <span className="text-sm font-medium text-gray-600 whitespace-nowrap"> 3 stars </span>
                            <div className="col-span-3 relative w-full bg-gray-200 rounded-full h-1.5">
                                <div className="absolute inset-y-0 left-0 w-[15%] bg-gray-900 rounded-full"></div>
                            </div>
                            <span className="text-sm font-medium text-gray-600 whitespace-nowrap"> 239 </span>
                        </li>

                        <li className="grid items-center grid-cols-5 gap-x-4">
                            <span className="text-sm font-medium text-gray-600 whitespace-nowrap"> 2 stars </span>
                            <div className="col-span-3 relative w-full bg-gray-200 rounded-full h-1.5">
                                <div className="absolute inset-y-0 left-0 w-[10%] bg-gray-900 rounded-full"></div>
                            </div>
                            <span className="text-sm font-medium text-gray-600 whitespace-nowrap"> 18 </span>
                        </li>

                        <li className="grid items-center grid-cols-5 gap-x-4">
                            <span className="text-sm font-medium text-gray-600 whitespace-nowrap"> 1 star </span>
                            <div className="col-span-3 relative w-full bg-gray-200 rounded-full h-1.5">
                                <div className="absolute inset-y-0 left-0 w-[20%] bg-gray-900 rounded-full"></div>
                            </div>
                            <span className="text-sm font-medium text-gray-600 whitespace-nowrap"> 472 </span>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div className="md:col-span-2">
                            ...
                            <div className="flex items-start mt-5 md:flex-col">
                                ...
                                <div className="flex items-center ml-4 text-sm font-medium text-gray-600 md:ml-0 md:mt-4">
                                    <svg className="h-5 text-green-500 flex-shrink-0 mr-1.5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
