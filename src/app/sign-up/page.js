    ...
    <section className="py-12 sm:py-16 lg:py-20 xl:py-24 bg-gray-50">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-xl mx-auto text-center">
          <h2 className="text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">Create Free Account</h2>
          <p className="mt-4 text-base font-normal leading-7 text-gray-600 lg:text-lg lg:mt-6 lg:leading-8">Searching is free for all CREC members.</p>
        </div>
        ...
        <div className="max-w-lg mx-auto mt-8 bg-white shadow-xl rounded-2xl sm:mt-12">
          <div className="p-6 sm:px-8">
            <form action="#" method="POST" className="space-y-5">
              ...
              <div className="relative flex items-start">
                <div className="flex items-center h-5">
                  <input type="checkbox" name="terms" id="terms" className="w-4 h-4 text-blue-600 border border-gray-200 rounded focus:outline-none focus:ring-blue-600" />
                </div>
                <div className="ml-3 text-sm">
                  <label htmlFor="terms" className="text-sm font-normal text-gray-700">
                    I agree with the<a href="#" title="" className="text-blue-600 hover:underline"> Terms & Conditions </a>
                    of CRECWorks.
                  </label>
                </div>
              </div>
            ...
            <div className="mt-6 space-y-6 text-center">
              ...
              <p className="text-sm font-normal text-gray-500">Already have an account? <a href="/sign-in" title="" className="text-sm font-semibold text-blue-600 hover:underline">Sign in</a></p>
            </div>
          </div>
        </div>
      </div>
