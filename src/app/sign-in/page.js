    ...
    <section className="py-12 sm:py-16 lg:py-20 xl:py-24 bg-gray-50">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-xl mx-auto text-center">
          <h2 className="text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">Welcome Back!</h2>
          {/* <p className="mt-4 text-base font-normal leading-7 text-gray-600 lg:text-lg lg:mt-6 lg:leading-8">Clarity gives you the blocks and components you need to create a truly professional website.</p> */}
        </div>
          ...
          <div className="p-6 sm:px-8">
              ...
              <div className="flex items-center justify-between">
                <div className="relative flex items-start">
                  <div className="flex items-center h-5">
                    <input type="checkbox" name="rememberMe" id="rememberMe" className="w-4 h-4 text-blue-600 border border-gray-200 rounded focus:outline-none focus:ring-blue-600" />
                  </div>
                  <div className="ml-3 text-sm">
                    <label htmlFor="rememberMe" className="text-sm font-normal text-gray-700"> Remember me </label>
                  </div>
                </div>

                <a href="#" title="" className="text-sm font-normal text-gray-900 hover:underline"> Forgot password? </a>
              </div>
            ...
            <div className="mt-6 space-y-6 text-center">
              <a
                ...
                role="button"
              >
                <svg className="w-6 h-6 mr-3" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
                    ...
                    fill="#167EE6"
                  />
                  <path d="M12.4241 19.3043C9.72629 19.3043 7.37109 17.8303 6.10616 15.649L2.03711 17.9944C4.10782 21.5832 7.98694 24 12.4241 24C14.6009 24 16.6548 23.4139 18.4242 22.3925V22.387L16.0735 18.3177C14.9983 18.9414 13.754 19.3043 12.4241 19.3043Z" fill="#12B347" />
                  <path d="M18.4258 22.3925V22.387L16.0752 18.3177C14.9999 18.9413 13.7558 19.3043 12.4258 19.3043V24C14.6025 24 16.6566 23.4139 18.4258 22.3925Z" fill="#0F993E" />
                  <path d="M5.12146 12C5.12146 10.6702 5.48437 9.42613 6.10786 8.35096L2.03881 6.00562C1.01182 7.76938 0.425781 9.81773 0.425781 12C0.425781 14.1824 1.01182 16.2307 2.03881 17.9945L6.10786 15.6491C5.48437 14.5739 5.12146 13.3298 5.12146 12Z" fill="#FFD500" />
                  <path
              ...
              <p className="text-sm font-normal text-gray-500">Don&apos;t have an account? <a href="/sign-up" title="" className="text-sm font-semibold text-blue-600 hover:underline">Sign up</a></p>
            </div>
          </div>
        </div>
      </div>
